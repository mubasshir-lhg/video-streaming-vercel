...
const createCustomShadow = (color) => {
  ...
  return {
    z1: `0 12px 12px 0 ${transparent}, 6px 6px 12px 0 ${transparent}`,
    z8: `0 12px 12px 0 ${transparent}, 8px 8px 16px 0 ${transparent}`,
    z12: `0 12px 12px 0 ${transparent}, 12px 12px 24px 0 ${transparent}`,
...
export const customShadows = createCustomShadow(DARK_MODE);
